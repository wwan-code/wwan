...
import { chapterPagesUpload } from '../middlewares/uploadComicFiles.js'; // Import middleware

const router = express.Router();

// User routes
router.get('/comics/:comicId/chapters', chapterController.getChaptersByComicId);
router.get('/chapters/:chapterId/pages', chapterController.getChapterWithPages);
