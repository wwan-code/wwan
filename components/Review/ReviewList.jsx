...
import RatingDisplayStars from './RatingDisplayStars';
        ...
        <div className="review-list-section mt-4">
            ...
            <div className="d-flex justify-content-between align-items-center mb-3">
                ...
                <div className="dropdown" ref={(el) => dropdownRefCallback(el, 921)}>
                    ...
                    <ul className={classNames("dropdown-menu dropdown-menu-end", {"show" : openDropdown === 921})} aria-labelledby="sortReviewDropdown">
            ...
            {!loading && !error && reviews.length > 0 && (
                <ul className="list-unstyled review-list">
                    {reviews.map((review) => {
                        ...
                        return (
                            <li key={review.id} className="review-item mb-3 pb-3 border-bottom">
                                    ...
                                    <div className="flex-grow-1">
                                        ...
                                        <div className="review-actions mt-1">
                                            {review.reviewContent && onLikeReview && (
                                                ...
                                                >
                                                    {/* Hiển thị spinner nếu đang liking */}
                                                    {isLiking ? (
