...
import classNames from '../../../utils/classNames'; // Đường dẫn đúng
...
const ComicMetaForm = ({
    ...
    useEffect(() => { setFilteredGenres(genres); }, [genres]); // Cập nhật khi genres gốc thay đổi
        ...
        <div className="card mb-4">
            ...
            <div className="card-body">
                ...
                <div className="mb-3">
                    ...
                    <div id="genres-select-comic" className='form-floating form-floating-advance-select'> {/* Thêm ID khác biệt */}
                ...
                {/* Bạn có thể thêm các trường metadata khác ở đây nếu cần */}
            </div>
        </div>
    );
};
