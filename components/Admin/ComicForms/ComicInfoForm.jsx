            ...
            <div className="card-body">
                ...
                <div className="mb-3">
                    ...
                    <input
                        ...
                        value={data.slug || slug} // Ưu tiên data.slug (khi edit), sau đó là slug từ hook
                        onChange={onInputChange} // Cho phép sửa slug nếu muốn
                        disabled={isSubmitting}
                    />
                ...
                <div className="mb-3">
                    ...
                    <textarea
                        ...
                        name="description"
                        className="form-control"
                        rows={7} // Tăng số dòng cho mô tả truyện
