...
// Helper functions (có thể tách ra file utils nếu dùng ở nhiều nơi)
...
const ComicCard = ({ comic, onDeleteComic, dropdownProps }) => {
    ...
    const coverImageUrl = comic.coverImage
        ...
        : '/placeholder-comic.png'; // Placeholder nếu không có ảnh
    ...
    return (
        <div className="col-custom-card"> {/* Sử dụng class tương tự movie list hoặc định nghĩa mới */}
            <div className="admin-content-card comic-admin-card h-100">
                <div className="card-image-container">
                    ...
                    {/* Overlay thông tin (tương tự MovieCard) */}
