...
const Dashboard = () => {
    ...
    useEffect(() => {
        const getStats = async () => {
            try {
                const res = await axios.get("/api/m/user/stats", {
                    headers: authHeader()
                });
                setStats(res.data);
            } catch (error) {
    ...
    useEffect(() => {
        const fetchMovieStats = async () => {
            try {
                const res = await axios.get(`/api/admin/movies/m/sorted-by-date`, {
                    headers: authHeader()
                });
    ...
    useEffect(() => {
        const fetchTrendingMovies = async () => {
            try {
                const res = await axios.get("/api/admin/movies/m/trending", {
                    headers: authHeader()
                });
